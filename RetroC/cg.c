...
//Allocate a free register; return the number of the register; end if no available registers
...
//Multiple two registers together and return the number of the register with the result
